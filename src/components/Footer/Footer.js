                ...
                <div class="sm:flex sm:flex-wrap justify-center sm:-mx-4 md:py-4">
                    <div class="px-4 sm:w-1/2 md:w-1/4 xl:w-1/6">
                        ...
                        <ul class="list-none footer-links">
                            <li class="mb-2">
                                <Link to="#" class="border-b border-solid border-transparent hover:border-purple-800 hover:text-purple-800">Most Applied Job</Link>
                            </li>
                            <li class="mb-2">
                    ...
                    <div class="px-4 sm:w-1/2 md:w-1/4 xl:w-1/6 mt-8 sm:mt-0">
                        ...
                        <ul class="list-none footer-links">
                            <li class="mb-2">
                                <Link to="#" class="border-b border-solid border-transparent hover:border-purple-800 hover:text-purple-800">About TribuneJob.com</Link>
                            </li>
                            <li class="mb-2">
                                <Link to="#" class="border-b border-solid border-transparent hover:border-purple-800 hover:text-purple-800">Job vacancy</Link>
                            </li>
                            <li class="mb-2">
                                <Link to="#" class="border-b border-solid border-transparent hover:border-purple-800 hover:text-purple-800">Job review</Link>
                            </li>
                            <li class="mb-2">

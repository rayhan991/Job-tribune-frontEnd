                            ...
                            <div className="flex flex-col justify-evenly py-5">
                                <div className="flex grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10  " key={product.id}>
                                    ...
                                    <div className="order-2 md:order-1 lg:order-1 content justify-center">
                                        ...
                                        <p className="text-center md:text-left lg:text-left text-1xl poppins text-gray-500 leading-relaxed select-none">Location-{product.location}</p>
                                        <p className="text-center md:text-left lg:text-left text-1xl poppins text-gray-500 leading-relaxed select-none">Type-{product.type}</p>
                                        <hr />
                                    ...
                                    <div className="order-1 md:order-2 lg:order-2">
                                        <div className="flex flex-col p-5" >
                                            <div className="mt-8">
                                                {/*                                         
                                                <Button text="Apply" onClick={product.applyLink} />
                                                <a href={product.applyLink}>button</a> */}

                                                <a href={product.applyLink} className="githubIcon" target="_blank" rel="noreferrer">
                                                    <Button text="Apply" />
                                                </a>
                                            </div>
                                        </div>
